...
# 保存序列到指定的路径
save_to_txt(TP_sequences, "myDNAPredict/program 1.1/sequence_to_analysis/Y_TP.txt")
save_to_txt(TN_sequences, "myDNAPredict/program 1.1/sequence_to_analysis/Y_TN.txt")
save_to_txt(FP_sequences, "myDNAPredict/program 1.1/sequence_to_analysis/Y_FP.txt")
save_to_txt(FN_sequences, "myDNAPredict/program 1.1/sequence_to_analysis/Y_FN.txt")
