...
pt_file = '/root/autodl-tmp/myDNAPredict/program 1.1/dl_model_ST/fold3_BERT_model.pt'
...
for name, data in data_dict.items():
    ...
    # Create separate scatter plots for positive and negative labels # ST test
    ...
    plt.title(f'UMAP visualization of ST test for {name}') #ST_test
    # plt.title(f'UMAP visualization of ST train for {name}') #ST_train
    ...
    # Save the figure
    print("Saving figure...")
    path = f"/root/autodl-tmp/myDNAPredict/program 1.1/figures/umap/umap_ST_test_{name}.png" #ST_test
    # path = f"/root/autodl-tmp/myDNAPredict/program 1.1/figures/umap/umap_ST_train_{name}.png" #ST_train
