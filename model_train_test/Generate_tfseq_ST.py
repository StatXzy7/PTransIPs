...
save_to_txt(TP_sequences, "./sequence_to_analysis/ST_TP.txt")
save_to_txt(TN_sequences, "./sequence_to_analysis/ST_TN.txt")
save_to_txt(FP_sequences, "./sequence_to_analysis/ST_FP.txt")
save_to_txt(FN_sequences, "./sequence_to_analysis/ST_FN.txt")
